...
public class Exercici3UF3M6 {
	...
	private static void modificaDep(Scanner teclado)throws XMLDBException{
		...
		String query = "update replace /departamentos/DEP_ROW[DEPT_NO ="+ numDep +"] with <DEP_ROW><DEPT_NO>" + numNouDep +
                        "</DEPT_NO>" + "<DNOMBRE>" + nomDepartament + "</DNOMBRE><LOC>" + llocDep +"</LOC></DEP_ROW>";
		consultar(query);
	}
